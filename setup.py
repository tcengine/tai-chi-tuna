...
setuptools.setup(
    ...
    url=f"https://github.com/{cfg['user']}/tai-chi-tuna",
    ...
    project_urls={
        "Documentation": "https://github/unpackai/tai-chi-tuna/",
        "Tracker": "https://github.com/unpackAI/tai-chi-tuna/issues",
    },
)